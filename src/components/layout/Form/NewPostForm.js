...
function NewPostForm({ handleSubmit, btnTitle, postData }) {
    ...
    return (
        <form onSubmit={submit} className={styles.containerNewPostForm}>
            ...
            <TextArea name="body" id="body" label="Digite o texto da postagem" rows="5" placeholder="Digite aqui o texto da postagem..." handleOnChange={handleChange} value={postContent.body ? postContent.body : ''}/>
